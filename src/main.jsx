...
const SECTORS = [
  { symbol: 'XLC', name: '通信服务', map: 'AI应用 / 传媒', stocks: '昆仑万维、中文在线、拓尔思、三六零、每日互动', driver: '平台型AI与数字广告预期', rationale: '美国互联网与AI应用交易强化，A股偏成长映射更敏感。' },
  { symbol: 'XLK', name: '信息技术', map: 'AI算力 / 服务器', stocks: '中际旭创、新易盛、天孚通信、光迅科技、沪电股份', driver: '算力资本开支与芯片链', rationale: '海外算力景气对A股硬件链有情绪与订单预期传导。' },
  { symbol: 'XLY', name: '可选消费', map: '智能汽车 / 消费电子', stocks: '比亚迪、立讯精密、宁德时代、歌尔股份、赛力斯', driver: '消费与电动车风险偏好', rationale: '可选消费走强通常利于A股成长消费，但需看人民币汇率与成交。' },
  { symbol: 'XLI', name: '工业', map: '高端制造 / 机器人', stocks: '汇川技术、绿的谐波、三一重工、埃斯顿、机器人', driver: '制造业自动化订单', rationale: '工业相对强弱改善时，A股设备与机器人往往获得情绪外溢。' },
  { symbol: 'XLV', name: '医疗保健', map: '创新药 / 医疗器械', stocks: '恒瑞医药、迈瑞医疗、华东医药、爱尔眼科、药明康德', driver: '医药防御与创新药', rationale: '防御板块走强更偏结构性机会，A股影响通常温和且分化。' },
  { symbol: 'XLE', name: '能源', map: '油气 / 石化', stocks: '中国石化、上海石化、中国石油、海油工程、广汇能源', driver: '油价与能源股相对表现', rationale: '能源走弱若伴随油价回落，A股油气链次日或承压。' },
  { symbol: 'XLF', name: '金融', map: '券商 / 银行', stocks: '中信证券、东方财富、招商银行、宁波银行、华泰证券', driver: '利率与金融条件', rationale: '金融板块变化主要通过风险偏好与美债利率间接映射。' },
]

const STOCKS = [
  ['NVDA', 'NVIDIA', 'AI算力 / 芯片', '中际旭创、新易盛、天孚通信、沪电股份、胜宏科技', '信息技术'], ['AMD', 'AMD', 'AI芯片 / 服务器', '寒武纪、海光信息、浪潮信息、中科曙光、紫光股份', '信息技术'], ['AVGO', 'Broadcom', '定制芯片 / 数据中心', '沪电股份、胜宏科技、生益科技、深南电路、景旺电子', '信息技术'], ['TSM', '台积电', '先进制程 / 代工', '中芯国际、北方华创、拓荆科技、华海清科、长电科技', '信息技术'], ['ARM', 'Arm Holdings', 'CPU架构 / 端侧AI', '瑞芯微、全志科技、晶晨股份、北京君正、国科微', '信息技术'], ['MRVL', 'Marvell', '光互连 / 数据中心', '天孚通信、光迅科技、中际旭创、新易盛、仕佳光子', '信息技术'], ['MU', 'Micron', '存储芯片 / HBM', '兆易创新、江波龙、澜起科技、佰维存储、德明利', '信息技术'], ['MSFT', 'Microsoft', '云计算 / AI软件', '用友网络、金山办公、浪潮信息、宝信软件、东方国信', '通信服务'], ['META', 'Meta Platforms', 'AI应用 / 广告', '昆仑万维、中文在线、拓尔思、三六零、每日互动', '通信服务'], ['GOOGL', 'Alphabet', 'AI搜索 / 云', '拓尔思、云从科技、科大讯飞、三六零、同花顺', '通信服务'], ['AMZN', 'Amazon', '云服务 / 电商', '宝信软件、焦点科技、值得买、南极电商、赛维时代', '可选消费'], ['AAPL', 'Apple', '消费电子 / 端侧AI', '立讯精密、歌尔股份、鹏鼎控股、蓝思科技、东山精密', '可选消费'], ['TSLA', 'Tesla', '智能汽车 / 电池', '比亚迪、宁德时代、拓普集团、三花智控、赛力斯', '可选消费'], ['PLTR', 'Palantir', 'AI软件 / 数据分析', '中科曙光、每日互动、海光信息、易华录、太极股份', '通信服务'], ['CRWD', 'CrowdStrike', '网络安全', '启明星辰、深信服、奇安信、安恒信息、绿盟科技', '通信服务'], ['PANW', 'Palo Alto', '网络安全', '奇安信、安恒信息、启明星辰、深信服、绿盟科技', '通信服务'], ['ORCL', 'Oracle', '云数据库 / AI', '浪潮信息、紫光股份、中科曙光、宝信软件、深信服', '信息技术'], ['VRT', 'Vertiv', '数据中心电源 / 液冷', '英维克、申菱环境、科华数据、奥飞数据、数据港', '工业'], ['GE', 'GE Aerospace', '航空制造', '中航沈飞、航发动力、中直股份、洪都航空、航天彩虹', '工业'], ['LLY', 'Eli Lilly', '创新药 / 减重药', '恒瑞医药、华东医药、丽珠集团、通化东宝、甘李药业', '医疗保健'], ['NVO', 'Novo Nordisk', '减重药 / 胰岛素', '甘李药业、通化东宝、华东医药、恒瑞医药、长春高新', '医疗保健'], ['XOM', 'Exxon Mobil', '原油 / 能源', '中国石化、海油工程、中国石油、广汇能源、海油发展', '能源'], ['CVX', 'Chevron', '原油 / 能源', '中国石油、上海石化、中国石化、海油工程、广汇能源', '能源'], ['FCX', 'Freeport-McMoRan', '铜 / 资源', '紫金矿业、洛阳钼业、江西铜业、铜陵有色、西部矿业', '材料'], ['UNH', 'UnitedHealth', '医疗保险', '爱尔眼科、通策医疗、迈瑞医疗、鱼跃医疗、乐普医疗', '医疗保健'], ['JPM', 'JPMorgan', '银行 / 金融', '招商银行、宁波银行、兴业银行、工商银行、平安银行', '金融'], ['GS', 'Goldman Sachs', '投行 / 资本市场', '中信证券、东方财富、华泰证券、国泰海通、申万宏源', '金融'], ['CAT', 'Caterpillar', '工程机械', '三一重工、徐工机械、中联重科、柳工、恒立液压', '工业'], ['DE', 'Deere', '农机 / 工业', '一拖股份、潍柴动力、天鹅股份、杭叉集团、安徽合力', '工业'], 
